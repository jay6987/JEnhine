...
#pragma region Others
		...
		void Convert_16f_to_32f(float* pDst, const signed short* pSrc, const size_t n);

		void Convert_32f_to_16f(signed short* pDst, const float* pSrc, const size_t n);
